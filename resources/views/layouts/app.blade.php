    ...
    <body class="font-sans bg-gray-background antialiased">
        <header class="flex items-center justify-between px-8 py-4">
            ...
            <div class="flex items-center">
                ...
                @endif
                <a href="#">
                    <img src="{{asset('avatar.png')}}" alt="avatar" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                <div class="bg-white border-2 border-blue rounded-xl mt-16"
                    ...
                    border-image:linear-gradient(to bottom, #ffffff. #ffffff), linear-gradient(to bottom, rgba(50,138,241,0.22), rgba(99,123,255,0)) ;
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full text-sm bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Describe Your Idea"></textarea>
                        </div>
